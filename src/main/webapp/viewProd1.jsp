...
<div class="col-md-12">
 ...
 <c:forEach var="userdsc" items="${lst}">
   ...
   <tr><td colspan="2">
   <div style="min-height:200px;background-size:cover; background-image: url('http://localhost:80/RetailProductsImageClassificationPython/DataSet/${userdsc.coverphoto}');"></div>
    </td></tr>
   <tr>
	 ...
	 <form action="AddToCart" method="post">
                                     <input type="hidden" name="prodId" value="${userdsc.getProdId()}"> 
                                        <input type="hidden" name="title" value="${userdsc.title}">
                                         ...
                                         <input type="hidden" name="page" value="ShowCart">
